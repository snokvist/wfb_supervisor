...
- `./wfb_supervisor --restart --restart-delay 3` restarts after shutdown, sleeping the given number of seconds (default 3) before relaunching (overrides any config-provided restart settings)
